const initialData = {
    tasks: {
        ...
        'task-2': {id: 'task-2', content: 'you can move a task around'},
        'task-3': {id: 'task-3', content: "and, of course, delete task"},
        ...
        'task-12': {id: 'task-12', content: 'Add social authentication for social media use'}
    },
    columns: {
        'column-1': {
            id: 'column-1',
